      ...
      children: [
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            ...
            filled: true,
            fillColor: const Color.fromARGB(255, 229, 255, 245),
            border: outlineInputBorder(AppColor.red),
            focusedBorder: outlineInputBorder(const Color.fromARGB(255, 0, 204, 177)),
            enabledBorder: outlineInputBorder(AppColor.primaryColor),
            hintText: hintText,
